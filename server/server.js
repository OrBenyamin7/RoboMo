...
const sslOptions = {
  key: fs.readFileSync("/etc/letsencrypt/live/robomo.hopto.org/privkey.pem"),
  cert: fs.readFileSync("/etc/letsencrypt/live/robomo.hopto.org/fullchain.pem"),
};
...
const io = socketIo(httpsServer, {
  cors: {
    origin: "https://robomo.onrender.com", // Your client URL
    methods: ["GET", "POST"],
